...
2. **LaunchedEffect or any state logic initialization**: The use of any state or launchedEfect logic should be placed also inside the corresponding screen if possible.